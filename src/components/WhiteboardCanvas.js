...
export default function WhiteboardCanvas() {
  ...
  const prevX = useSelector((state) => state.whiteboardCanvas.prevX);
  const prevY = useSelector((state) => state.whiteboardCanvas.prevY);
  const localDrawing = useSelector(
    (state) => state.whiteboardCanvas.localDrawing
  );
  const remoteDrawing = useSelector(
    (state) => state.whiteboardCanvas.remoteDrawing
  );
  const x = useSelector((state) => state.whiteboardCanvas.x);
  const y = useSelector((state) => state.whiteboardCanvas.y);
